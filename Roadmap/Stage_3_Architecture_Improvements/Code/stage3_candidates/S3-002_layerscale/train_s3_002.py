"""
S3-002 -- LayerScale (learnable per-channel gain on every block's two
residual branches, init 1.0). Motivated by Items 1, 2A, 2B (Stage2
Decision Report Sec. 4/6) and Task 0.1's now-verified dilution finding.

Usage:
    python train_s3_002.py                # full training (Phase 2, GPU)
    python train_s3_002.py --smoke-test    # CPU shape/gradient check only
"""
